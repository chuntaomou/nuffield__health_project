...
$.ajax({
	...
	url: 'http://localhost:3000/materialinfoid',
	success: function(data){
		...
		$("#Material-Valid-From").append((data[0])["Material Valid From"]);
		$("#Material-Valid-To").append((data[0])["Material Valid To"]);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////		
		...
		$("#child-association").append("<div class='panel panel-default text-center'><div class='panel-heading'><h1>Association</h1></div><div class='panel-body'><input id='"+(data[0])["Child Association:Association Id"]+"' class='original-parent-material-id'></input><input id='"+(data[0])["Child Association:Association Id"]+"' class='search-child-material-id'></input><p id='"+(data[0])["Child Association:Association Id"]+"' class='association-type-id'>"+(data[0])["Child Association:Association Type Id"]+"</p><label><strong>Association Type Name</strong></label><p id='"+(data[0])["Child Association:Association Id"]+"' class='association-id'>"+(data[0])["Child Association:Association Type Name"]+"</p><label><strong>Parent Material</strong></label><div id='Parent-Material-Name-"+(data[0])["Child Association:Association Id"]+"'><p id='"+(data[0])["Child Association:Association Id"]+"' class='parent-material-name'>"+(data[0])["Child Association:Parent Material Name"]+"</p><!-- --><input id='"+(data[0])["Child Association:Association Id"]+"' class='search-parent-material' style='width:110px; display:none;' placeholder='Search term...'></input><!-- --><button id='"+(data[0])["Child Association:Association Id"]+"' class='btn btn-default search-association-parent-material-button' style='min-width:35px; display:none;'><span id='"+(data[0])["Child Association:Association Id"]+"' class='glyphicon glyphicon-search'></span></button><div id='"+(data[0])["Child Association:Association Id"]+"' class='dropdown association' style='display:none;'><button id='menu2' class='btn btn-default dropdown-toggle' data-toggle='dropdown'>results<span class='caret'></span></button><ul id='"+(data[0])["Child Association:Association Id"]+"' class='dropdown-menu' style='height:200px; overflow-y:scroll; width:240px;' role='menu' aria-labelledby='menu2'></ul></div></div><label><strong>Child Material</strong></label><p id='"+(data[0])["Child Association:Association Id"]+"'>"+(data[0])["Child Association:Child Material Name"]+"</p><label for='association-date-from-"+(data[0])["Child Association:Association Id"]+"'><strong>Association Valid From</strong></label><p id='"+(data[0])["Child Association:Association Id"]+"' class='material-association-valid-from'>"+(data[0])["Child Association:Material Association Valid From"]+"</p><label for='association-date-to-"+(data[0])["Child Association:Association Id"]+"'><strong>Association Valid To</strong></label><p id='"+(data[0])["Child Association:Association Id"]+"' class='material-association-valid-to'>"+(data[0])["Child Association:Material Association Valid To"]+"</p></div><div class='panel-footer'><button id='"+(data[0])["Child Association:Association Id"]+"' class='btn btn-lg edit-association-info'>Edit</button><!-- --><button style='display:none;' id='"+(data[0])["Child Association:Association Id"]+"' class='btn btn-lg cancel-association-info'>Cancel</button><!-- --><button style='display:none;' id='"+(data[0])["Child Association:Association Id"]+"' class='btn btn-lg update-association-info'>Update</button></div></div>");
		...
		for(var i=0;i<length;i++){
			$("#association-list").append("<div class='col-sm-4'><div class='panel panel-default text-center'><div class='panel-heading'><h1>Association</h1></div><div class='panel-body'><input id='"+(data[i])["Parent Association:Association Id"]+"' class='original-child-material-id'></input><input id='"+(data[i])["Parent Association:Association Id"]+"' class='search-result-material-id'></input><p id='"+(data[i])["Parent Association:Association Id"]+"' class='association-type-id'>"+(data[i])["Parent Association:Association Type Id"]+"</p><label><strong>Association Type Name</strong></label><p id='"+(data[i])["Parent Association:Association Id"]+"' class='association-id'>"+(data[i])["Parent Association:Association Type Name"]+"</p><label><strong>Parent Material</strong></label><p id='"+(data[i])["Parent Association:Association Id"]+"' class='parent-material-name'>"+(data[i])["Parent Association:Parent Material Name"]+"</p><label><strong>Child Material</strong></label><div id='Child-Material-Name-"+(data[i])["Parent Association:Association Id"]+"'><p id='"+(data[i])["Parent Association:Association Id"]+"' class='child-material-name'>"+(data[i])["Parent Association:Child Material Name"]+"</p><!-- --><input id='"+(data[i])["Parent Association:Association Id"]+"' class='search-child-material' style='width:110px; display:none;' placeholder='Search term...'></input><!-- --><button id='"+(data[i])["Parent Association:Association Id"]+"' class='btn btn-default search-association-child-material-button' style='min-width:35px; display:none;'><span id='"+(data[i])["Parent Association:Association Id"]+"' class='glyphicon glyphicon-search'></span></button><div id='"+(data[i])["Parent Association:Association Id"]+"' class='dropdown association' style='display:none;'><button id='menu1' class='btn btn-default dropdown-toggle' data-toggle='dropdown'>results<span class='caret'></span></button><ul id='"+(data[i])["Parent Association:Association Id"]+"' class='dropdown-menu' style='height: 200px; overflow-y:scroll; width: 240px;' role='menu' aria-labelledby='menu1'></ul></div></div><label for='association-date-from-"+(data[i])["Parent Association:Association Id"]+"'><strong>Association Valid From</strong></label><p id='"+(data[i])["Parent Association:Association Id"]+"' class='material-association-valid-from'>"+(data[i])["Parent Association:Material Association Valid From"]+"</p><label for='association-date-to-"+(data[i])["Parent Association:Association Id"]+"'><strong>Association Valid To</strong></label><p id='"+(data[i])["Parent Association:Association Id"]+"' class='material-association-valid-to'>"+(data[0])["Parent Association:Material Association Valid To"]+"</p></div><div class='panel-footer'><button id='"+(data[i])["Parent Association:Association Id"]+"' class='btn btn-lg edit-parent-association-info'>Edit</button><!-- --><button style='display:none;' id='"+(data[i])["Parent Association:Association Id"]+"' value="+i+" class='btn btn-lg cancel-parent-association-info'>Cancel</button><!-- --><button style='display:none;' id='"+(data[i])["Parent Association:Association Id"]+"' class='btn btn-lg update-parent-association-info'>Update</button></div></div></div>");
