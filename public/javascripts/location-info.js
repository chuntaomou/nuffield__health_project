...
////////////////////////////////////////////////////////////////////////////////////////
		...
		$("a.parent-location-name").click(function(e){
			window.location.href ="/location-info#location-id:"+$(e.target).attr('value');
			location.reload();
		});
		
		$("a.child-location-name").click(function(e){
			window.location.href ="/location-info#location-id:"+$(e.target).attr('value');
			location.reload();
		});
	}
