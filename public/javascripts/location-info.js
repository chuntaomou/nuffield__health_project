...
$.ajax({
	...
	url: 'http://localhost:3000/locationinfoid',
	success: function(data){
		...
		$("#Location-Valid-From").append((data[0])["Location Valid From"]);
		$("#Location-Valid-To").append((data[0])["Location Valid To"]);
